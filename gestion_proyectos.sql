...
CREATE TABLE `entregas` (
  ...
  CONSTRAINT `fk_entrega_tarea` FOREIGN KEY (`id_tarea`) REFERENCES `tareas` (`id`),
...
INSERT INTO `entregas` VALUES (1,10,16,'https://example.com/uploads/1762965919715_taller virtualbox.pdf','','2025-11-12 16:45:19'),(2,7,16,'https://example.com/uploads/1762969332704_calendariodocente.html','','2025-11-12 17:42:12');
...
CREATE TABLE `notas` (
  ...
  KEY `fk_nota_entrega` (`id_entrega`),
  CONSTRAINT `fk_nota_entrega` FOREIGN KEY (`id_entrega`) REFERENCES `entregas` (`id_entrega`),
...
INSERT INTO `notas` VALUES (1,1,1,NULL,'Entrega final',4.80,30,'2025-05-30','Excelente resultado final.'),(2,2,1,NULL,'Documentación técnica',4.50,20,'2025-05-25','Documentación detallada y clara.'),(3,3,2,NULL,'Desarrollo backend',4.20,25,'2025-07-10','Cumple con los requisitos funcionales.'),(4,4,2,NULL,'Diseño UI',3.90,15,'2025-06-30','Necesita mejorar consistencia visual.'),(5,5,3,NULL,'Propuesta inicial',4.00,10,'2025-06-10','Propuesta aceptada sin observaciones.'),(6,6,4,NULL,'Entrega intermedia',4.60,25,'2025-05-15','Buen avance general.'),(7,7,5,NULL,'Análisis de requerimientos',4.70,20,'2025-04-20','Bien estructurado y completo.');
...
INSERT INTO `proyectos` VALUES (1,'Sistema de Gestión','Desarrollo de una plataforma para gestionar notas y estudiantes','2025-11-15','2025-11-30','[1, 21, 3]','completado','2025-10-29 21:10:43','2025-11-12 17:51:05'),(2,'App de Tareas Colaborativas','Aplicación web para asignación y seguimiento de tareas de equipo','2025-03-01','2025-07-15','[4, 5, 6]','activo','2025-10-29 21:10:43','2025-11-11 23:32:04'),(3,'Portal de Proyectos Universitarios','Sitio web para registrar y evaluar proyectos finales','2025-06-01','2025-11-30','[2, 3, 7]','pendiente','2025-10-29 21:10:43','2025-11-11 23:32:04'),(4,'Control de Inventarios','Sistema para administrar productos, stock y proveedores','2025-02-10','2025-06-25','[8, 9, 10]','activo','2025-10-29 21:10:43','2025-11-11 23:32:04'),(5,'Gestión de Recursos Humanos','Aplicación para registrar empleados y gestionar nómina','2025-04-01','2025-09-30','[5, 6]','pendiente','2025-10-29 21:10:43','2025-11-11 23:32:04'),(6,'proyect','project','2025-11-25','2025-11-30','[16, 17, 18, 19, 21]','pendiente','2025-11-12 04:55:54','2025-11-12 17:50:49');
...
-- Dump completed on 2025-11-12 10:24:30
